...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full flex justify-between items-center border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
